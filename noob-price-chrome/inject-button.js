...
async function buscarOfertasSteam() {
  ...
  const skeletonHtml = `<div class="noobprice-skeleton" aria-busy="true" aria-label="Carregando ofertas">
    ...
    <div style="display:flex;align-items:center;gap:14px;padding:14px 16px;margin-bottom:12px;background:linear-gradient(135deg,#1e1e2f,#2c2c3f);border:1px solid #3f3f5a;border-radius:12px;"><div style="width:40px;height:40px;border-radius:8px;background:linear-gradient(90deg,#3f3f5a 25%,#4b5563 50%,#3f3f5a 75%);background-size:200% 100%;animation:noobprice-shimmer 1.2s ease-in-out infinite;"></div><div style="flex:1;"><div style="height:14px;width:55%;margin-bottom:8px;border-radius:4px;background:linear-gradient(90deg,#3f3f5a 25%,#4b5563 50%,#3f3f5a 75%);background-size:200% 100%;animation:noobprice-shimmer 1.2s ease-in-out infinite;"></div><div style="height:12px;width:35%;border-radius:4px;background:linear-gradient(90deg,#3f3f5a 25%,#4b5563 50%,#3f3f5a 75%);background-size:200% 100%;animation:noobprice-shimmer 1.2s ease-in-out infinite;"></div></div><div style="display:flex;align-items:center;gap:14px;padding:14px 16px;margin-bottom:12px;background:linear-gradient(135deg,#1e1e2f,#2c2c3f);border:1px solid #3f3f5a;border-radius:12px;"><div style="width:40px;height:40px;border-radius:8px;background:linear-gradient(90deg,#3f3f5a 25%,#4b5563 50%,#3f3f5a 75%);background-size:200% 100%;animation:noobprice-shimmer 1.2s ease-in-out infinite;"></div><div style="flex:1;"><div style="height:14px;width:50%;margin-bottom:8px;border-radius:4px;background:linear-gradient(90deg,#3f3f5a 25%,#4b5563 50%,#3f3f5a 75%);background-size:200% 100%;animation:noobprice-shimmer 1.2s ease-in-out infinite;"></div><div style="height:12px;width:45%;border-radius:4px;background:linear-gradient(90deg,#3f3f5a 25%,#4b5563 50%,#3f3f5a 75%);background-size:200% 100%;animation:noobprice-shimmer 1.2s ease-in-out infinite;"></div></div>
